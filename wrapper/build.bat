cl /O2 /MT /DUNICODE /D_UNICODE /I7z wrapper.c ^
  ...
  /utf-8 /link /SUBSYSTEM:CONSOLE Shlwapi.lib Shell32.lib Ole32.lib User32.lib




cl /nologo /O2 /MT /W3 /DUNICODE /D_UNICODE x64patch.c /link advapi32.lib shlwapi.lib
